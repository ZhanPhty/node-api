    ...
    if ($('#recordButton').is('.recordPlayButtonSelected')) {
      ...
      for (var eventListIdx in eventList) {
        ...
        if (eventListItem.eventType === 'OnDrag') {
          var lastDrag =
            eventListItem.eventInfo.mousePositions[eventListItem.eventInfo.mousePositions.length - 1].dragInfo
          ...
          eventListItem.eventInfo.dragInfo.xDelta =
            eventListItem.eventInfo.dragInfo.currentX - eventListItem.eventInfo.dragInfo.lastX
          eventListItem.eventInfo.dragInfo.yDelta =
            eventListItem.eventInfo.dragInfo.currentY - eventListItem.eventInfo.dragInfo.lastY
          transmissionFields = {}
