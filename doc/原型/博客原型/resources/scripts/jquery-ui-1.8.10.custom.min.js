  ...
  d.widget('ui.draggable', d.ui.mouse, {
    ...
    _mouseStop: function(a) {
      ...
      if (
        ...
        (d.isFunction(this.options.revert) && this.options.revert.call(this.element, b))
      ) {
        var c = this
    ...
    _convertPositionTo: function(a, b) {
      ...
      return {
        top:
          ...
          (d.browser.safari && d.browser.version < 526 && this.cssPosition == 'fixed'
            ? 0
            : (this.cssPosition == 'fixed' ? -this.scrollParent.scrollTop() : f ? 0 : c.scrollTop()) * a),
        left:
          b.left +
          ...
          (d.browser.safari && d.browser.version < 526 && this.cssPosition == 'fixed'
            ? 0
            : (this.cssPosition == 'fixed' ? -this.scrollParent.scrollLeft() : f ? 0 : c.scrollLeft()) * a)
      }
    },
      ...
      for (
        ...
        if (
          ...
          if (f.snapMode != 'inner') {
            ...
            if (r)
              b.position.left =
                c._convertPositionTo('relative', { top: 0, left: i - c.helperProportions.width }).left -
                c.margins.left
            if (s)
          ...
          if (f.snapMode != 'outer') {
            ...
            if (q)
              b.position.top =
                c._convertPositionTo('relative', { top: l - c.helperProportions.height, left: 0 }).top -
                c.margins.top
            if (r)
              b.position.left = c._convertPositionTo('relative', { top: 0, left: i }).left - c.margins.left
            if (s)
              b.position.left =
                c._convertPositionTo('relative', { top: 0, left: k - c.helperProportions.width }).left -
                c.margins.left
          }
